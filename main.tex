...
\usepackage{calc}
\usepackage{datatool}% http://ctan.org/pkg/datatool  for TOC sorted
\usepackage{xspace}
\usepackage{xcolor}
\usepackage{float} \usepackage[usestackEOL]{stackengine}
\usepackage{chordbox}
\usepackage{multirow}
...
%%\fancyfoot[LO]{\hspace{\leftpadding}\thepage}
%%\fancyfoot[RE]{\thepage\hspace{\leftpadding}}
...
\newfontfamily\larken{Larken Bold}
