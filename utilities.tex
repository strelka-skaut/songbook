...
\makeatletter
\NewDocumentCommand{\mysong}{mmm+m}{%
  \phantomsection
  \addcontentsline{toc}{subsection}{#1}
  \hspace{\leftpadding}
  \begin{tabularx}{\linewidth - \leftpadding - 0.5cm}{Xr} 
    \savecellbox{\shortstack[l]{\fontsize{24}{24}\setmainfont{Larken Bold}\hyperref[content]{#1}\ifblank{#2}{}{\vspace{0.05em}\\\small \trim@spaces{#2}\ifblank{#3}{}{, \trim@spaces{#3}} }} %#1
    } & \savecellbox{\ifthenelse{\boolean{showchords}}{$\text{\footnotesize \shortstack[r]{#4} }$}{}} \\ [-\rowheight]
    %} & \savecellbox{\ifthenelse{\boolean{showchords}}{\footnotesize #4}{}} \\ [-\rowheight]
    \printcellmiddle & \multirow[t]{2}{*}{\printcelltop} \\
    %\fontsize{24}{24}\setmainfont{Larken Bold} #1 & \multirow[t]{2}{*}{\footnotesize #4} \\
    %\ifblank{#2}{}{\small \trim@spaces{#2}\ifblank{#3}{}{, \trim@spaces{#3}} & \\ }
  \end{tabularx}
}
\makeatother
